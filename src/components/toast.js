...
const isIphoneX = () => {
  return (
    Platform.OS === "ios" &&
    ((ScreenWidth === iphoneXWidth && ScreenHeight === iphoneXHeight) ||
      (ScreenHeight === iphoneXWidth && ScreenWidth === iphoneXHeight))
  );
};
const isIphoneXX = () => {
  return (
    Platform.OS === "ios" &&
    ((ScreenWidth === iphoneXXWidth && ScreenHeight === iphoneXXHeight) ||
      (ScreenHeight === iphoneXXWidth && ScreenWidth === iphoneXXHeight))
  );
};
